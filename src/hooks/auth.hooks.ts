...
// Initialize privacy settings and detect Face ID availability - exact Ledger Live implementation
...
export function useAppStateHandler({ isPasswordLockBlocked, lock }: UseAppStateHandlerProps) {
  ...
  // Exact implementation from Ledger Live
...
// Custom error class to match Ledger Live
...
const VIBRATION_PATTERN_ERROR = [0, 80, 100, 80];
